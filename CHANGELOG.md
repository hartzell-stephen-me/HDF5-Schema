...
### Fixes
- Fixed bug meta schemas paths in manifest having backslashes instead of forward slashes.
...
[1.0.2]: https://github.com/hartzell-stephen-me/hdf5schema/releases/tag/1.0.2
